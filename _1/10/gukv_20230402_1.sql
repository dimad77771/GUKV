...
SELECT 
        ...
        (SELECT Q.stan_recieve_name FROM dict_stan_recieve Q where Q.stan_recieve_id = rep.stan_recieve_id) stan_recieve_name2,
		rep.*,
		ar.NumOfSubmAgr, 
		ar.NumOfAgr, 
		obj.NumOfSubmObj, 
  ...
  --      ,ObjectAndRentTotals4.*
		...
		,OrganizationProperties.prim_balanc
...
--Довідник сфер діяльності
select * from dict_rent_occupation

--Довідник галузей
select * from dict_org_industry

--Вид Діяльності
select * from dict_org_occupation

--Орган госп. упр.
select * from dict_org_old_organ
...
industry,
occupation,
'https://balans.gukv.gov.ua/card/' + zkpo_code,
form_gosp,
form_of_ownership,
org_form,
old_organ
...
FlowFile[filename=39ea3296-caa7-42b8-b8ad-f0c7d27b3f13] routing to failure: org.apache.nifi.processor.exception.ProcessException: org.apache.avro.SchemaParseException: Empty name
