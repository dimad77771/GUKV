...
'https://balans.gukv.gov.ua/card/' + zkpo_code as [Фін.звітн.],
...
PAY_AVANCE_PLAT as [Авансова орендна плата (нараховано), грн.],
...
PAY_AVANCE_SALDO as [Сальдо авансової орендної плати на початок звітного періоду, грн. (без ПДВ)],
...
PAY_AVANCE_PAYMENTNAR as [- у тому числі, з нарахованої авансової орендної плати, грн.],
...
PAY_DEBT_V_MEZH as [- в тому числі (із загальної заборг.) заборг. з орендної плати, розмір якої встановлено в межах витрат на утрим., грн. (без ПДВ)],
