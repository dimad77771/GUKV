declare @period_year integer = 2022
...
(
	...
	sum(case when dict_rent_occupation_name = 'Íåâèçíà÷åí³' then 1 else 0 end) ax3,
	sum(case when dict_rent_occupation_name = 'Íåâèçíà÷åí³' and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) bx3,
	sum(case when dict_rent_occupation_name = 'Íåâèçíà÷åí³' and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cx3,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' then 1 else 0 end) ax2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) bx2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cx2,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 then 1 else 0 end) ax4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) bx4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cx4,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 then NumOfObj else 0 end) ax5,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then NumOfObj else 0 end) bx5,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then NumOfObj else 0 end) cx5,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 then SQR_TOTAL_BAL else 0 end) ax6,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then SQR_TOTAL_BAL else 0 end) bx6,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and NumOfObj >= 1 and is_pleso = 0 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then SQR_TOTAL_BAL else 0 end) cx6,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' then 1 else 0 end) ay1,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) by1,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cy1,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 then 1 else 0 end) ay2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) by2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cy2,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 then NumOfObj else 0 end) ay3,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then NumOfObj else 0 end) by3,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then NumOfObj else 0 end) cy3,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 then SQR_TOTAL_BAL else 0 end) ay4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then SQR_TOTAL_BAL else 0 end) by4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'Ì²ÑÜÊÀ ÊÎÌÓÍÀËÜÍÀ' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then SQR_TOTAL_BAL else 0 end) cy4,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' then 1 else 0 end) az1,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) bz1,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cz1,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 then 1 else 0 end) az2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then 1 else 0 end) bz2,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then 1 else 0 end) cz2,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 then NumOfObj else 0 end) az3,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then NumOfObj else 0 end) bz3,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then NumOfObj else 0 end) cz3,

	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 then SQR_TOTAL_BAL else 0 end) az4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÁŞÄÆÅÒÍÀ' then SQR_TOTAL_BAL else 0 end) bz4,
	sum(case when dict_rent_occupation_name <> 'Íåâèçíà÷åí³' and is_pleso = 0 and form_of_ownership = 'ÊÎÌÓÍÀËÜÍÀ (ÑÔÅĞÀ ÓÏĞÀÂË²ÍÍß ĞÄÀ)' and NumOfObj >= 1 and form_gosp = 'ÃÎÑÏĞÎÇĞÀÕÓÍÊÎÂÀ' then SQR_TOTAL_BAL else 0 end) cz4,

	(SELECT count(*) FROM [corporprav]) as dx1,
	...
	(
		SELECT 
				isnull(ddd.name, 'Íåâ³äîìî') as 'dict_rent_occupation_name',
				...
				rep.old_organ,
				case when rep.zkpo_code in ('23505151') then 1 else 0 end as is_pleso,
				--rep.*,
				ar.NumOfSubmAgr, 
				ar.NumOfAgr, 
				obj.NumOfSubmObj, 
				...
				CASE WHEN rep.is_reviewed = 0 THEN N'ÍI' ELSE N'ÒÀÊ' END AS 'review_performed'
        
				--,ReportDates.*
        
				,ObjectAndRentTotals1.SQR_TOTAL_BAL
...
(
    ...
    (
        SELECT 
                ...
                (rep.arenda_rented_max_submit_date),
                (rep.org_max_submit_date)) AS AllMaxSubmitDates(sdt)) AS max_submit_date,
                CASE WHEN rep.is_reviewed = 0 THEN NÍI ELSE NÒÀÊ END AS review_performed
                ,ObjectAndRentTotals1.SQR_TOTAL_BAL
                ,isnull(PAY_RECV_ZVIT,0) + isnull(PAY_RECV_OTHER,0) - isnull(PAY_RETURN_ALL_OREND_PAYED,0) as PAY_RECV_ZVIT_new
                FROM view_reports1nf rep
                LEFT JOIN (SELECT sum(CASE WHEN (r1a.submit_date IS NULL OR r1a.modify_date IS NULL OR r1a.modify_date > r1a.submit_date) THEN 0 ELSE 1 END) as NumOfSubmAgr, 
            ...
            SELECT
                ...
                LEFT JOIN (
                SELECT
                    org.full_name AS SUBMITTER_FULL_NAME
                   ,org.short_name AS SUBMITTER_SHORT_NAME 
                   ,org.zkpo_code AS SUBMITTER_ZKPO
                   ,dict_org_industry.name AS ORG_INDUSTRY
                   ,dict_org_occupation.name AS ORG_OCCUPATION
                   ,dict_org_status.name AS ORG_STATUS
                   ,dict_org_form_gosp.name AS ORG_FIN_FORM 
                   ,dict_org_ownership.name AS ORG_OWNERSHIP 
                   ,dict_org_gosp_struct.name AS gosp_struct 
                   ,dict_org_vedomstvo.name AS ORG_VEDOMSTVO
                   ,dict_org_form.name AS ORG_GOSP_FORM 
                   ,dict_org_old_organ.name AS ORG_GOSP_UPR 
                   ,director_fio AS BOSS_FIO 
                   ,director_phone AS BOSS_TEL
                   ,director_email AS BOSS_EMAIL
                   ,director_title AS BOSS_POSADA
                   ,kved_code AS ORG_KVED
                   ,ph_street.name AS physAddrStreet 
                   ,org.phys_addr_nomer AS physAddrNumber
                   ,org.phys_addr_misc AS physAddrMisc
                   ,CASE WHEN org.contribution_rate IS NULL THEN 0 ELSE ORG.contribution_rate END AS ORG_CONTRIB_RATE 
                   ,org.buhgalter_fio AS USER_FIO 
                   ,org.buhgalter_phone AS USER_TEL 
                   ,org.buhgalter_email AS USER_EMAIL 
                   ,org.budget_narah_50_uah AS PAY_50_NARAH
                   ,kazna.pay_sum AS PAY_50_PAYED
                   ,org.budget_prev_50_uah AS PAY_50_DEBT
                   ,org.budget_debt_30_50_uah AS PAY_50_DEBT_OLD 
                   ,org.payment_budget_special AS PAY_SPECIAL
                   ,CASE WHEN (ISNULL(org.budget_narah_50_uah, 0) - ISNULL(kazna.pay_sum, 0) + ISNULL(org.budget_prev_50_uah, 0)) - ISNULL(org.unknown_payments,0) < 0 THEN 0 Else (ISNULL(org.budget_narah_50_uah, 0) - ISNULL(kazna.pay_sum, 0) + ISNULL(org.budget_prev_50_uah, 0)) - ISNULL(org.unknown_payments,0) END AS PAY_50_DEBT_CUR
                   ,org.konkurs_payments AS PAY_RECV_OTHER
                   ,org.report_id
                   ,dict_otdel_gukv.name as otdel_gukv
                ...
                LEFT JOIN (
                SELECT
                        isnull(SUM(pay.payment_narah),0) - isnull(SUM(pay.znyato_nadmirno_narah),0) as PAY_NARAH_ZVIT
                        ,SUM(pay.last_year_saldo) as PAY_PEREPLATA
                        ,SUM(pay.zabezdepoz_prishlo) as PAY_ZABEZDEPOZ_PRISHLO 
                        ,SUM(pay.payment_received) as PAY_RECV_ZVIT 
                        ,SUM(pay.payment_nar_zvit) as PAY_RECV_NARAH
                        ,SUM(pay.debt_total) as PAY_DEBT_TOTAL
                        ,SUM(pay.debt_zvit) as PAY_DEBT_ZVIT
                        ,SUM(pay.debt_v_mezhah_vitrat) as PAY_DEBT_V_MEZH 
                        ,SUM(pay.debt_spysano) as debt_spysano
                        ,SUM(pay.old_debts_payed) as PAY_LAST_PER
                        ,SUM( isnull(pay.payment_narah,0) - isnull(pay.znyato_nadmirno_narah,0) ) as PAY_NARAH_ZVIT_NORMAL 
                        ,SUM(pay.znyato_nadmirno_narah) as PAY_ZNYATO_NADMIRNO_NARAH
                        ,SUM(pay.zabezdepoz_saldo) as PAY_AVANCE_SALDO 
                        ,SUM(pay.avance_plat) as PAY_AVANCE_PLAT 
                        ,SUM(pay.total_pereplata) as PAY_PEREPLATA_ALL 
                        ,SUM(pay.avance_debt) as PAY_AVANCE_DEBT 
                        ,SUM(pay.avance_paymentnar) as PAY_AVANCE_PAYMENTNAR 
                        ,SUM(pay.return_orend_payed) as PAY_RETURN_OREND_PAYED 
                        ,SUM(pay.znyato_from_avance) as PAY_ZNYATO_FROM_AVANCE 
                        ,SUM(pay.return_all_orend_payed) as PAY_RETURN_ALL_OREND_PAYED 
                        ,report_id
                        ,rent_period_id
                    FROM reports1nf_arenda_payments pay
                    WHERE NOT EXISTS(SELECT id FROM arenda a WHERE a.id = pay.arenda_id AND ISNULL(a.is_deleted, 0) = 1)  and pay.arenda_id > 0
