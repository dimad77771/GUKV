<%@ page title="Log In" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Account_Login, App_Web_1hdydluz" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false" 
        ...
        DestinationPageUrl="~/Reports1NF/ReportList.aspx">
        <LayoutTemplate>
