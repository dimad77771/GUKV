...
namespace GUKV.ImportToolUtils
{
    ...
    public static class DB
    {
        ...
        private static Dictionary<int, int> objectTypeMappingNJFto1NF = FieldMappings.CreateObjectTypeMappingNJFto1NF(-1, -1, -1);
        ...
        public static void LoadData(Preferences preferences)
        {
            ...
            FbConnection connectionNJF = new FbConnection(preferences.GetNJFConnectionString("SYSDBA", "masterkey"));
        ...
        public static void FillComboBoxFromDictionary1NF(ASPxComboBox combo, string dictionaryName)
        {
            combo.Items.Clear();
            ...
            if (dictionaries.TryGetValue(dictionaryName, out data))
            {
                foreach (KeyValuePair<int, DictionaryValue> pair in data.Values1NF)
                {
                    combo.Items.Add(pair.Value.ToString(), pair.Value);
                }
            }
        }
/*
        ...
        */
            ...
            out int streetId, out int districtId)
        {
            ...
            if (nomer3.StartsWith(GUKV.ImportToolUtils.AppResources.KorpusPrefix))
            {
                    ...
                    if (deleteSucceeded)
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("dbo.fnDeleteBalansObjectInReport", connectionSql))
                        {
                            try
                            {
                                ...
                                EmailNotifier.NotifyBalansObjectRemoved(connectionSql, null, balansId);
                            }
                            catch (Exception ex)
                            {
                                throw;
        ...
        private static void ChangeBalansObjectSquare(FbConnection connection1NF, FbTransaction transaction, SqlConnection connectionSql, int balansId, decimal newSquare)
        {
            ...
            int balansId, int newOwnerOrgId, DocumentNJF rishennya)
        {
            ...
            FieldMappings.Create1NFBalansFieldMapping(mapping, false, true);
                    ...
                    if (insertedOK)
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("dbo.fnAddBalansObjectToReport", connectionSql))
                        {
                            try
                            {
                                ...
                                EmailNotifier.NotifyBalansObjectAdded(connectionSql, null, newBalansId);
                            }
                            catch (Exception ex)
                            {
                                throw;
    ...
    public class Preferences
    {
        ...
        public const string iniFolderName = "C:\\ImportTool";
