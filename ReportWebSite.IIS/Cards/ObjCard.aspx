<%@ page language="C#" autoeventwireup="true" inherits="Cards_ObjCard, App_Web_objcard.aspx.f411966a" masterpagefile="~/NoMenu.master" title="Картка Об'єкту" validaterequest="false" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceObjCardArenda" runat="server" 
    ...
    SelectCommand="SELECT arenda_id, org_renter_full_name, org_renter_id, org_giver_full_name, org_giver_id, rent_square, agreement_num,
        rent_start_date, rent_finish_date, is_subarenda, purpose, object_name, agreement_active_int FROM m_view_arenda_agreements
