<%@ page language="C#" autoeventwireup="true" inherits="Documents_DocRelations, App_Web_docrelations.aspx.e819a670" masterpagefile="~/NoHeader.master" title="Документи" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceDocuments" runat="server" EnableCaching="true"
...
<dx:ASPxGridView ID="PrimaryGridView" runat="server" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="parent_topic" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="7" Visible="True" Caption="Назва" Width="230px">
            <DataItemTemplate>
        ...
        <dx:GridViewDataTextColumn FieldName="child_topic" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="22" Visible="True" Caption="Назва Підп. Документа" Width="230px">
            <DataItemTemplate>
        ...
        <dx:GridViewDataTextColumn FieldName="child_note" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="23" Visible="False" Caption="Примітка Підп. Документа"></dx:GridViewDataTextColumn>
        <dx:GridViewDataDateColumn FieldName="child_receive_date" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="24" Visible="False" Caption="Дата Отримання Підп. Документа"></dx:GridViewDataDateColumn>
        <dx:GridViewDataTextColumn FieldName="child_commission" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="25" Visible="False" Caption="Комісія Підп. Документа"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="child_source" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="26" Visible="False" Caption="Джерело Підп. Документа"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="child_state" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="27" Visible="False" Caption="Стан Підп. Документа"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="child_summa" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="28" Visible="False" Caption="Сума за Підп. Документом (тис.грн.)"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="child_summa_zalishkova" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="29" Visible="False" Caption="Залишкова Сума за Підп. Документом (тис.грн.)"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="parent_is_rozp" ReadOnly="True" ShowInCustomizationForm="True"
            VisibleIndex="30" Visible="False" Caption="Розпорядчий Документ"></dx:GridViewDataTextColumn>
    </Columns>
    ...
    <SettingsCookies CookiesID="GUKV.DocRelations" Version="A2" Enabled="True" />
    <Styles Header-Wrap="True" >
        <Header Wrap="True"></Header>
    </Styles>

    <ClientSideEvents Init="GridViewDocumentsInit" EndCallback="GridViewDocumentsEndCallback" />
</dx:ASPxGridView>
