<%@ page language="C#" autoeventwireup="true" inherits="Arenda_RentedObjects, App_Web_rentedobjects.aspx.6fa4e802" masterpagefile="~/NoHeader.master" title="Орендовані Об'єкти" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceArendaObjects" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT * FROM m_view_arenda WHERE
