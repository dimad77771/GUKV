<%@ page title="База даних ДКВ м. Києва" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="_Default, App_Web_default.aspx.cdcab7d2" %>
        ...
        SelectCommand="SELECT id, report_name, 
                        CASE 
                            ...
                            WHEN category = 21 THEN 
		                        'OrendnaPlata/OrPlataTotals.aspx?grid=' + CAST(category AS VARCHAR(10)) + '&amp;report=' + CAST(id AS VARCHAR(10)) 
