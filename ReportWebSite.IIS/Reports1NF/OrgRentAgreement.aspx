<%@ page language="C#" autoeventwireup="true" inherits="Reports1NF_OrgRentAgreement, App_Web_orgrentagreement.aspx.5d94abc0" masterpagefile="~/NoMenu.master" title="Картка Договору Оренди" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRentAgreement" runat="server" 
    ...
    SelectCommand="SELECT TOP 1 ar.*,
        ...
        LEFT OUTER JOIN organizations org_renter ON org_renter.id = ar.org_renter_id
        LEFT OUTER JOIN organizations org_giver ON org_giver.id = ar.org_giver_id
        LEFT OUTER JOIN organizations org_balans ON org_balans.id = ar.org_balans_id
...
SELECT id, zkpo_code + ' - ' + full_name AS 'search_name' FROM organizations org WHERE
	...
	org.id IN (@balans_org, 27065, 8515, 8400, 1728, 8109, 9826, 15130, 141824, 137676, 8566, 13128))
UNION ALL	
SELECT id, zkpo_code + ' - ' + full_name AS 'search_name' FROM organizations org WHERE
	@zkpo != '^' AND
	@fname != '^' AND
	org.id in (SELECT TOP 20 id FROM organizations WHERE zkpo_code LIKE @zkpo AND full_name LIKE @fname AND (is_deleted IS NULL OR is_deleted = 0) AND master_org_id IS NULL AND id < 300000)"
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceOrgSearchRenter" runat="server" 
    ...
    SelectCommand="SELECT id, zkpo_code + ' - ' + full_name AS 'search_name' FROM organizations org
        WHERE
	        ...
	        OR
        	(@zkpo != '^' AND @fname != '^' AND org.id IN (SELECT TOP 20 id FROM organizations WHERE zkpo_code LIKE @zkpo AND full_name LIKE @fname AND (is_deleted IS NULL OR is_deleted = 0) AND master_org_id IS NULL AND id < 300000)))
                                    ...
                                    <dx:PanelContent ID="PanelContent1" runat="server">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2" width="810px">
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxTextBox ID="EditAgreementNum" runat="server" Text='<%# Eval("agreement_num") %>' Width="190px" Title="Номер договору оренди" MaxLength="18" OnValidation="OnValidation">
                                                        <ValidationSettings Display="None" ValidationGroup="MainGroup" EnableCustomValidation="true" ErrorText="Необхідно вказати номер договору оренди"></ValidationSettings>
                                                    </dx:ASPxTextBox>
                                                </td>
                                                <td> &nbsp; </td>
                                                <td><dx:ASPxLabel ID="ASPxLabel36" runat="server" Text="Дата укладання договору"></dx:ASPxLabel></td>
                                                <td>
                                                    <dx:ASPxDateEdit ID="EditAgreementDate" runat="server" Value='<%# Eval("agreement_date") %>' Width="190px" Title="Дата укладання договору" OnValidation="OnValidation">
                                                        <ValidationSettings Display="None" ValidationGroup="MainGroup" EnableCustomValidation="true" ErrorText="Необхідно вказати дату укладання договору"></ValidationSettings>
                                                    </dx:ASPxDateEdit>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxDateEdit ID="EditStartDate" runat="server" Value='<%# Eval("rent_start_date") %>' Width="190px" Title="Дата початку оренди" OnValidation="OnValidation">
                                                        <ValidationSettings Display="None" ValidationGroup="MainGroup" EnableCustomValidation="true" ErrorText="Необхідно вказати дату початку оренди"></ValidationSettings>
                                                    </dx:ASPxDateEdit>
                                                </td>
                                                <td> &nbsp; </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxComboBox ID="ComboPaymentType" runat="server" ValueType="System.Int32" TextField="name" ValueField="id" Width="190px" 
                                                        ...
                                                        Title="Вид оплати" OnValidation="OnValidation">
                                                        <ValidationSettings Display="None" ValidationGroup="MainGroup" ErrorText="Необхідно вибрати вид оплати за договором"> <RequiredField IsRequired="false" ErrorText="Необхідно вибрати вид оплати за договором" /> </ValidationSettings>
                                                    </dx:ASPxComboBox>
                                                </td>
                                                <td> &nbsp; </td>
                                                <td><dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Фактична дата закінчення договору"></dx:ASPxLabel></td>
                                                <td><dx:ASPxDateEdit ID="EditActualFinishDate" runat="server" Value='<%# Eval("rent_actual_finish_date") %>' Width="190px" Title="Фактична дата закінчення оренди" /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Вартість приміщень за договором, грн"></dx:ASPxLabel></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <dx:ASPxRadioButton ID="RadioAgreementToxic" runat="server" GroupName="AgreementState" Value='<%# 1.Equals(Eval("agr_toxic")) %>'
                                                        Text="Договір закінчився, але заборгованність не погашено" Title="Договір закінчився, але заборгованність не погашено" /> 
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <PanelCollection>
                            <dx:panelcontent ID="Panelcontent2" runat="server">
                                ...
                                <dx:ASPxGridView ID="GridViewDecisions" ClientInstanceName="GridViewDecisions" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Settings HorizontalScrollBarMode="Visible" ShowFooter="True" ShowFilterRow="True" ShowFilterRowMenu="True" ShowFilterBar="Visible" ShowHeaderFilterButton="True" />
                            ...
                            <dx:panelcontent ID="Panelcontent3" runat="server">
                                ...
                                <dx:ASPxGridView ID="GridViewNotes" ClientInstanceName="GridViewNotes" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="purpose_group_id" VisibleIndex="4" Caption="Група використання за класифікацією" Width="140px">
                                            <PropertiesComboBox DataSourceID="SqlDataSourcePurposeGroup" ValueField="id" TextField="name" ValueType="System.Int32" />
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataComboBoxColumn FieldName="purpose_id" VisibleIndex="5" Caption="Використання за класифікацією" Width="140px">
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="cost_expert_total" VisibleIndex="7" Caption="Ринкова вартість, грн." Width="100px"></dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="note_status_id" VisibleIndex="13" Caption="Поточний стан" Width="140px">
                                        ...
                                        <EditForm>
                                            <table border="0" cellspacing="0" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td> <dx:ASPxTextBox ID="EditNoteSqr" runat="server" Width="200px" Text='<%# Eval("rent_square")%>' /> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <dx:ASPxLabel ID="ASPxLabel46" runat="server" Text="Поточний стан приміщення" Width="150px" /> </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td> <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="Група використання за класифікацією" Width="150px" /> </td>
                                                    <td>
                                                    ...
                                                    <td> <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="Використання за класифікацією" Width="150px" /> </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <dx:ASPxTextBox ID="EditNoteCostNarah" runat="server" Width="200px" Text='<%# Eval("cost_narah")%>' /> </td>
                                                    <td> <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text="Ставка за використання, грн." Width="150px" /> </td>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="2" width="810px">
                                                    <tr>
                                                        ...
                                                        <td><dx:ASPxSpinEdit ID="EditPaymentNarah_orndpymnt" runat="server" NumberType="Float" Value='<%# Eval("payment_narah") %>' Width="150px"
                                                            Title="Нараховано орендної плати за звітний період"/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><dx:ASPxSpinEdit ID="EditPaymentNarZvit_orndpymnt" runat="server" NumberType="Float" Value='<%# Eval("payment_nar_zvit") %>' Width="150px"
                                                            Title="Надходження орендної плати з нарахованої за звітний період"/></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2" width="810px">
                                            ...
                                            <tr>
                                                ...
                                                <td><dx:ASPxSpinEdit ID="EditCollectionDebtTotal" ClientInstanceName="EditCollectionDebtTotal" runat="server" NumberType="Float" Value='<%# Eval("debt_total") %>' Width="100px"
                                                    Title="Загальна заборгованість по орендній платі"/></td>
