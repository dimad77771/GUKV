<%@ page language="C#" autoeventwireup="true" inherits="Reports1NF_OrgRentedObject, App_Web_orgrentedobject.aspx.5d94abc0" masterpagefile="~/NoMenu.master" title="Картка Договору Орендування" %>
                ...
                <dx:PanelContent ID="PanelContent4" runat="server">
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="810px">
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="EditAgrNum" runat="server" Text='<%# Eval("agreement_num") %>' Width="190px" MaxLength="18" Title="Номер договору орендування" OnValidation="OnValidation">
                                    <ValidationSettings Display="None" ValidationGroup="MainGroup" EnableCustomValidation="true" ErrorText="Необхідно вказати номер договору орендування"></ValidationSettings>
                                </dx:ASPxTextBox>
                            </td>
                            <td> &nbsp; </td>
                            <td><dx:ASPxLabel ID="ASPxLabel36" runat="server" Text="Дата укладання договору"></dx:ASPxLabel></td>
                            <td>
                                <dx:ASPxDateEdit ID="EditAgrDate" runat="server" Value='<%# Eval("agreement_date") %>' Width="100%" Title="Дата укладання договору" OnValidation="OnValidation">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxDateEdit ID="EditAgrStartDate" runat="server" Value='<%# Eval("rent_start_date") %>' Width="190px" Title="Початок оренди згідно з договором" OnValidation="OnValidation">
