<%@ page language="C#" autoeventwireup="true" inherits="Reports1NF_TransferRequestAdd, App_Web_transferrequestadd.aspx.5d94abc0" masterpagefile="~/NoMenu.master" title="Зміна балансоутримувачів об'єктів - Новий запрос" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <dx:ASPxComboBox ID="ComboRozpDoc" runat="server" ClientInstanceName="ComboRozpDoc"
                                                        ...
                                                        TextFormatString="{0}" FilterMinLength="3"
