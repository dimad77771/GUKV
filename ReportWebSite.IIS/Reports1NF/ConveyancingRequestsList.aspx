<%@ page language="C#" autoeventwireup="true" inherits="Reports1NF_ConveyancingRequestsList, App_Web_conveyancingrequestslist.aspx.5d94abc0" masterpagefile="~/NoMenu.master" title="Зміна балансоутримувачів об'єктів" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceConveyancingRequests" runat="server"
    ...
    SelectCommand="
        ...
        FROM transfer_requests req LEFT JOIN view_balans_all vb ON req.balans_id = vb.balans_id LEFT JOIN organizations org_from ON req.org_from_id = org_from.id LEFT JOIN organizations org_to ON req.org_to_id = org_to.id
        ...
        org_from.zkpo_code org_from_zkpo, org_from.full_name org_from_name, org_to.zkpo_code org_to_zkpo, org_to.full_name org_to_name
        FROM transfer_requests req LEFT JOIN unverified_balans ub ON req.balans_id = ub.id LEFT JOIN organizations org_from ON req.org_from_id = org_from.id LEFT JOIN organizations org_to ON req.org_to_id = org_to.id
...
<div class="buttons-panel">
    <div class="action-button-wrapper">
        <dx:ASPxButton ID="ASPxButton3" runat="server" Text="Прийняти об'єкт на баланс" AutoPostBack="false">
