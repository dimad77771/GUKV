<%@ page language="C#" autoeventwireup="true" inherits="OrendnaPlata_OrPlataNotSubmitted, App_Web_orplatanotsubmitted.aspx.1303f1bf" masterpagefile="~/NoHeader.master" title="Перелік Подавачів Звіту з Орендної Плати" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRentNotSubmitted" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT * FROM view_rent_not_submitted WHERE (@p_rda_district_id = 0 OR (org_sfera_upr_id = 4 AND org_district_id = @p_rda_district_id))"
