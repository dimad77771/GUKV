<%@ page language="C#" autoeventwireup="true" inherits="OrendnaPlata_OrPlataObjectsUse, App_Web_orplataobjectsuse.aspx.1303f1bf" masterpagefile="~/NoHeader.master" title="Орендна Плата - Використання Неж. Фонду" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRentObjectsUse" runat="server" EnableCaching="true"
    ...
    FROM
        ...
        LEFT OUTER JOIN organizations org ON org.id = rbo.organization_id
        LEFT OUTER JOIN dict_org_ownership ON org.form_ownership_id = dict_org_ownership.id
    WHERE
        (@p_rda_district_id = 0 OR (org.sfera_upr_id = 4 AND org.addr_distr_new_id = @p_rda_district_id))"
