<%@ page language="C#" autoeventwireup="true" inherits="OrendnaPlata_OrPlataByBuildings, App_Web_orplatabybuildings.aspx.1303f1bf" masterpagefile="~/NoHeader.master" title="Орендна Плата - Приміщення" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRentByBuildings" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT * FROM view_rent_by_buildings WHERE (@p_rda_district_id = 0 OR (bal_org_sfera_upr_id = 4 AND bal_org_district_id = @p_rda_district_id))"
