<%@ page language="C#" autoeventwireup="true" inherits="OrendnaPlata_OrPlataByRenters, App_Web_orplatabyrenters.aspx.1303f1bf" masterpagefile="~/NoHeader.master" title="Орендна Плата - Орендарі" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRentByRenters" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT * FROM view_rent_by_renters WHERE @p_rda_district_id = 0 OR
        (bal_org_sfera_upr_id = 4 AND bal_org_district_id = @p_rda_district_id) OR
        (giver_org_sfera_upr_id = 4 AND giver_org_district_id = @p_rda_district_id)"
