<%@ control language="C#" autoeventwireup="true" inherits="BPRishProject_RishProjectList, App_Web_rishprojectlist.ascx.23e82b75" %>
...
<script type="text/javascript" language="javascript">
    ...
    function OnAddNewRishProject(s, e) {
        ...
        if (typeof NewRishState.GetValue() != "string" || NewRishState.GetValue().length == 0) {
            alert("Будь ласка, виберіть початковий стан документу.");
            return;
        }
        ...
        GridViewRishProjects.PerformCallback(JSON.stringify({
            ...
            InitialStateID: NewRishState.GetValue()
        }));
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceRishProjects" runat="server" 
    ...
    SelectCommand="SELECT proj.*, info.*, st.name AS 'project_state', t.name AS 'project_type',
        ...
        INNER JOIN dict_rish_project_state st ON st.id = info.state_id
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelRishProjectListTitle" runat="server" Text="Проекти Розпорядчих Документів" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
                    ...
                    <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                        ...
                        <div style="float: right;">
                            ...
                            <dx:ASPxComboBox ID="NewRishContact" ClientInstanceName="NewRishContact" 
                                ...
                                TextFormatString="{1}">
                                <ClientSideEvents EndCallback="function(s, e) { s.SetSelectedIndex(s.cpSelectedIndex); }" />
                                <Columns>
                        ...
                        <dx:ASPxComboBox ID="NewRishState" Width="360px"
                            ClientInstanceName="NewRishState" runat="server" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceProjectStates" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
                            SelectCommand="SELECT id, name FROM dict_rish_project_state">
                        </asp:SqlDataSource>
                        <br />
                        <br />
                        <table border="0" cellspacing="4" cellpadding="0" width="100%">
