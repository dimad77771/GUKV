<%@ page language="C#" autoeventwireup="true" inherits="ObjRights_ObjRightTransfer, App_Web_objects.aspx.a8c63d73" masterpagefile="~/NoHeader.master" title="Передача Прав" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceObjectTransfer" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT * FROM m_view_object_rights WHERE
        ...
        (org_to_sfera_upr_id = 4 AND org_to_district_id = @p_rda_district_id) OR
        (org_from_sfera_upr_id = 4 AND org_from_district_id = @p_rda_district_id)">
    <SelectParameters>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceObjectTransfer_InclusivePreFilter" runat="server" EnableCaching="true"
    ...
    SelectCommand="SELECT vor.* 
                    ...
                    WHERE EXISTS(
                        ...
                        AND
                        ((@p_rda_district_id = 0) OR
                        (vor.org_to_sfera_upr_id = 4 AND vor.org_to_district_id = @p_rda_district_id) OR
                        (vor.org_from_sfera_upr_id = 4 AND vor.org_from_district_id = @p_rda_district_id))">
    <SelectParameters>
