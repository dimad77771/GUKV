...
namespace GUKV.DataMigration
{
    ...
    //                    if (Properties.Settings.Default.AddrTypeVillage.Contains(w))
    //                    {
    //                        isVillage = true;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypeCity.Contains(w))
    //                    {
    //                        isCity = true;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypeAvenue.Contains(w))
    //                    {
    //                        streetTp = StreetType.Avenue;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypeBoulevard.Contains(w))
    //                    {
    //                        streetTp = StreetType.Boulevard;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypeLane.Contains(w))
    //                    {
    //                        streetTp = StreetType.Lane;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypeSquare.Contains(w))
    //                    {
    //                        streetTp = StreetType.Square;
    //                    }
    //                    else if (Properties.Settings.Default.AddrTypePark.Contains(w))
    //                    {
    ...
    //    /// </summary>
    //    private Dictionary<string, List<int>> objAddrMapToId1NF = new Dictionary<string, List<int>>();//MODIFIED TO LIST
    ...
    //    /// </summary>
    //    private Dictionary<string, List<int>> objAddrMapToId1NF_WithDistrict = new Dictionary<string, List<int>>();//MODIFIED TO LIST
    ...
    //    /// </summary>
    //    private HashSet<string> streetNames = new HashSet<string>();
    ...
    //    /// </summary>
    //    private static string litPrefixLITd = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix;

    //    /// <summary>
    //    /// Prefix 'LITER.' for a building number
    //    /// </summary>
    //    private static string litPrefixLITERd = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix2;

    //    /// <summary>
    //    /// Prefix 'LITERA' for a building number
    //    /// </summary>
    //    private static string litPrefixLITERA = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix3;

    //    /// <summary>
    //    /// Prefix 'LITER' for a building number
    //    /// </summary>
    //    private static string litPrefixLITER = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix4;

    //    /// <summary>
    //    /// Prefix 'LITER .' for a building number
    //    /// </summary>
    //    private static string litPrefixLITER_d = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix5;

    //    /// <summary>
    //    /// Prefix 'LITER  .' for a building number
    //    /// </summary>
    //    private static string litPrefixLITER__d = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix6;

    //    /// <summary>
    //    /// Prefix 'LITERA -' for a building number
    //    /// </summary>
    //    private static string litPrefixLITER_sh = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix7;

    //    /// <summary>
    //    /// Prefix 'LIT' for a building number
    //    /// </summary>
    //    private static string litPrefixLIT = GUKV.DataMigration.Properties.Resources.BuildingLitPrefix8;

    //    /// <summary>
    //    /// 'PROV.' suffix for a street name
    //    /// </summary>
    //    private static string streetSuffixProv = GUKV.DataMigration.Properties.Resources.StreetSuffixProv;

    //    /// <summary>
    //    /// 'PROSP.' suffix for a street name
    //    /// </summary>
    //    private static string streetSuffixProsp = GUKV.DataMigration.Properties.Resources.StreetSuffixProsp;

    //    /// <summary>
    //    /// 'BULV.' suffix for a street name
    //    /// </summary>
    //    private static string streetSuffixBulv = GUKV.DataMigration.Properties.Resources.StreetSuffixBulv;

    //    /// <summary>
    //    /// 'K.' prefix for a building number
    //    /// </summary>
    //    private static string korpusPrefixCorrect = GUKV.DataMigration.Properties.Resources.BuildingKorpusPrefixCorrect;

    //    /// <summary>
    //    /// 'KORP.' prefix for a building number
    //    /// </summary>
    //    private static string korpusPrefix1 = GUKV.DataMigration.Properties.Resources.BuildingKorpusPrefix1;

    //    /// <summary>
    //    /// 'korp.' prefix for a building number
    //    /// </summary>
    //    private static string korpusPrefix2 = GUKV.DataMigration.Properties.Resources.BuildingKorpusPrefix2;

    //    /// <summary>
    //    /// 'K-' prefix for a building number
    //    /// </summary>
    //    private static string korpusPrefix3 = GUKV.DataMigration.Properties.Resources.BuildingKorpusPrefix3;

    //    /// <summary>
    //    /// 'DOK-' prefix for a building number
    //    /// </summary>
    //    private static string dockPrefix1 = GUKV.DataMigration.Properties.Resources.BuildingDockPrefix1;

    //    /// <summary>
    //    /// 'Ch.' prefix for a building number
    //    /// </summary>
    //    private static string partPrefix1 = GUKV.DataMigration.Properties.Resources.BuildingPartPrefix1;
    ...
    //                    {
    //                        streetNamesById[(int)dataId] = new StreetName((string)dataStreet);
    //                        streetNames.Add(((string)dataStreet).Trim().ToLower());
    //                    }
    //                }
    ...
    //    //                {
    //    //                    streetNamesById[(int)dataKod] = new StreetName((string)dataStreet);
    //    //                    streetNames.Add(((string)dataStreet).Trim().ToLower());
    //    //                }
    //    //            }
    ...
    //            AddObjectToCacheDictionary(objAddrMapToId1NF, fullAddress, buildingId);
    ...
    //    public int FindObject(string street1, string street2, string nomer1, string nomer2, string nomer3,
    ...
    //    public static int FindObjectByStreetId(SqlConnection connection, int streetId,
    //        string nomer1, string nomer2, string nomer3, string addrDopInfo)
    //    {
    //        bool useOnlyObjectsFrom1NF = false;
    //        int foundObjectId = -1;
    ...
    //    private int FindObjectByUnifiedAddress(UnifiedAddress uniAddr, object district, object square)
    //    {
    ...
    //        List<int> foundBuildingIdList = new List<int>();
    ...
    //                    return int.MinValue;
    //            }
    //            //if (objAddrMapToId1NF_WithDistrict.TryGetValue(AddDistrictCodetoAddressKey(fullAddress, (int)district), out buildingId))
    //            //{
    //            //    return buildingId;
    //            //}
    //        }
    ...
    //        if (objAddrMapToId1NF.TryGetValue(fullAddress, out outList))
    //        {
    //            if (outList.Count == 1)
    //                    return outList[0];
    //                else
    ...
    //                {
    //                    if (addrCopy.litera.Trim() == Properties.Resources.LiteraA)
    //                    {
    //                        addrCopy.litera = "";
    //                        repeatSearch = true;
    //                    }
    ...
    //                else
    //                {
    //                    addrCopy.litera = Properties.Resources.LiteraA;
    //                    repeatSearch = true;
    //                }
    ...
    //    {
    //        return streetNames.Contains(streetName.ToLower());
    //    }
    ...
    //    {
    //        // Special cases
    //        if (street.Contains(Properties.Resources.StreetAntonovaShort))
    //        {
    //            if (street.Contains(Properties.Resources.StreetOvsienkaShort))
    //            {
    //                street = Properties.Resources.StreetAntonovaOvs;
    //            }
    //            else
    //            {
    //                street = Properties.Resources.StreetAntonovaAvia;
    //            }
    ...
    //        // General cases
    //        foreach (string correction in Properties.Settings.Default.StreetNameCorrections)
    //        {
    ...
    //        if (str == GUKV.DataMigration.Properties.Resources.LesiUkrainkiShort)
    //        {
    //            str = GUKV.DataMigration.Properties.Resources.LesiUkrainkiCorrect;
    //        }

    //        return str;
    //    }

    //    private static void ParseAddressNumbers(string numbers, UnifiedAddress address)
    //    {
    ...
    //        numbers = numbers.Replace(GUKV.DataMigration.Properties.Resources.BuildingAddressNoNumber,
    //            GUKV.DataMigration.Properties.Resources.BuildingAddressNoNumberCorrect);

    //        numbers = numbers.Replace(GUKV.DataMigration.Properties.Resources.BuildingPrefixNumber, "");

    //        // Remove the duplicate KORPOS prefix
    //        int dupCorpusPos = numbers.IndexOf(GUKV.DataMigration.Properties.Resources.BuildingKorpusDuplicate);

    //        while (dupCorpusPos >= 0)
    //        {
    //            numbers = numbers.Remove(dupCorpusPos, GUKV.DataMigration.Properties.Resources.BuildingKorpusDuplicate.Length);

    //            dupCorpusPos = numbers.IndexOf(GUKV.DataMigration.Properties.Resources.BuildingKorpusDuplicate);
    //        }
    ...
    //    {
    //        foreach (string suffix in Properties.Settings.Default.AddressMiscSuffixes)
    //        {
    ...
    //                                int objectId = FindObject(street, "", number, "", "", "", null, null,
    ...
    //    {
    //        return token.StartsWith(Properties.Resources.CrossRoadPrefix + " ");
    //    }
    ...
    //        isStreet |= CheckStringTokenPrefix(ref token, Properties.Settings.Default.StreetAvenuePrefixList,
    //            Properties.Resources.StreetKindAvenueCorrect);

    //        isStreet |= CheckStringTokenPrefix(ref token, Properties.Settings.Default.StreetBoulevardPrefixList,
    //            Properties.Resources.StreetKindBoulevardCorrect);

    //        isStreet |= CheckStringTokenPrefix(ref token, Properties.Settings.Default.StreetLanePrefixList,
    //            Properties.Resources.StreetKindLaneCorrect);

    //        isStreet |= CheckStringTokenPrefix(ref token, Properties.Settings.Default.StreetSquarePrefixList,
    //            Properties.Resources.StreetKindSquareCorrect);

    //        // Remove unnecessary street suffixes
    //        if (token.EndsWith(" " + Properties.Resources.StreetSuffix1))
    //        {
    //            token = token.Substring(0, token.Length - Properties.Resources.StreetSuffix1.Length);
    //            isStreet = true;
    //        }

    //        if (token.EndsWith(" " + Properties.Resources.StreetSuffix2))
    //        {
    //            token = token.Substring(0, token.Length - Properties.Resources.StreetSuffix2.Length);
    //            isStreet = true;
    //        }

    //        if (token.StartsWith(Properties.Resources.StreetSuffix1))
    //        {
    //            token = token.Substring(Properties.Resources.StreetSuffix1.Length);
    //            isStreet = true;
    //        }
    ...
    //    {
    //        return
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix2) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix3) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix4) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix5) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix6) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix7) ||
    //            token.StartsWith(Properties.Resources.BuildingLitPrefix8);
    //    }
