...
namespace GUKV.ImportToolUtils
{
    ...
    public class OrganizationFinder
    {
        ...
        public void BuildOrganizationCacheFromSqlServer(SqlConnection connection, bool writeLogs)
        {
            ...
            // Get the required columns from the SZKPO table
            string querySelect = "SELECT id, zkpo_code, full_name, short_name, industry_id, occupation_id, form_ownership_id, is_deleted FROM organizations WHERE master_org_id IS NULL";
