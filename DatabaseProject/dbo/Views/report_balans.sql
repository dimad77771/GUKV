...
SELECT
   ...
   ,[bal].[building_id] AS 'building_id'
   ,[bal].[street_full_name] AS 'building_street'
   ,[bal].[addr_nomer] AS 'building_nomer'
   ,[bal].[district] AS 'building_district'
   ,[bal].[addr_zip_code] AS 'building_zip_code'
   ,[bal].[condition] AS 'building_condition'
   ,[bal].[bti_code] AS 'building_bti_code'
   ,[bal].[history] AS 'building_history'
   ,[bal].[object_type] AS 'building_type'
   ,[bal].[object_kind] AS 'building_kind'
   ,[bal].[sqr_total] AS 'building_sqr_total'
   ,[bal].[facade] AS 'building_facade'
FROM
    ...
    /**/
    LEFT OUTER JOIN view_org_balans bal ON organizations.id = bal.organization_id
