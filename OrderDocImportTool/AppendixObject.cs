        ...
        public string FormatTransfers()
        {
            ...
            foreach (Transfer t in transfers)
            {
                ...
                string transferStr = string.Format("{0} {1}\n{2} {3}\n{4} {5}",
                    Properties.AppResources.TransferTooltipFormatFrom, t.orgNameFrom,
                    Properties.AppResources.TransferTooltipFormatTo, t.orgNameTo,
                    Properties.AppResources.TransferTooltipFormatRight, rightName);
