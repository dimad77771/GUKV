...
public partial class Arenda_RentSubleases : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (isFirstLoading)
		{
			...
			if (this.ProcessPageLoad(out reportTitle, out preFilter, out fixedColumns) == Utils.GridIDArenda_Subleases)
			{
	...
	protected void GridViewArendaObjects_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
	{
		...
		Utils.ProcessDataGridSaveLayoutCallback(param, PrimaryGridView, Utils.GridIDArenda_Subleases, "");
	}
