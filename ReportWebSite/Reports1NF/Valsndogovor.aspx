<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Valsndogovor.aspx.cs" Inherits="Reports1NF_Report1NFPrivatisatSquare"
...
UpdateCommand="UPDATE [valsndogovor]
SET
    [nomer_zapis] = @nomer_zapis
    ,[priyom_date] = @priyom_date
    ,[nazva_vlasn] = @nazva_vlasn
    ,[address] = @address
    ,[plosha] = @plosha
    ,[result] = @result
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle1" runat="server" Text="Перелік об'єктів нерухомого майна, на які оформляється право власності" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridViewExporter ID="GridViewFreeSquareExporter" runat="server" 
   ...
   <dx:ASPxGridView ID="PrivatisatGridView" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="nazva_vlasn" Caption="Назва замовника / власника" Width="400px" >
        </dx:GridViewDataTextColumn>

        <dx:GridViewDataSpinEditColumn FieldName="plosha" Caption="Площа" Width="100px" >
        </dx:GridViewDataSpinEditColumn>

        <dx:GridViewDataTextColumn FieldName="address" Caption="Адреса об'єкта" Width="400px" >
        </dx:GridViewDataTextColumn>

        <dx:GridViewDataTextColumn FieldName="result" Caption="Результат розгляду питання щодо оформлення права власності" Width="650px" >
        </dx:GridViewDataTextColumn>


        <dx:GridViewDataTextColumn FieldName="modify_date2" Caption="Дата редагу-вання"  Width="75px" Visible="false">
			<HeaderStyle Wrap="True" />
			<EditItemTemplate>
				<dx:ASPxLabel runat="server" Text='<%# Eval("modify_date2") %>' CssClass="editLabelFormStyle"></dx:ASPxLabel>
			</EditItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="modified_by2" Caption="Користувач"  Width="100px" Visible="false">
			<EditItemTemplate>
...
<%--    <TotalSummary>
    ...
    <SettingsCookies CookiesID="GUKV.Reports1NF.valsndogovor" Version="A2_006" Enabled="True" />
