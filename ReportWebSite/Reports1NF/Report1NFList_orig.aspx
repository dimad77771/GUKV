...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="Отримано орендної плати в тому числі з нарахованої за звітний період, грн. (без ПДВ)" FieldName="PAY_RECV_NARAH" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="58"  />
