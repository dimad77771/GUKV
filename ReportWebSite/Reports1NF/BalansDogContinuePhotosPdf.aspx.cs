...
public partial class Reports1NF_Cabinet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		{
			var fname = @"cinfo_" + id + ".zip";
			var bytes = new BalansFreeSquarePhotosJpegBulder().Go(id);
	...
	public class BalansFreeSquarePhotosPdfBulder
	{
		...
		void ConfigInit()
		{
			...
			photo1NFPath = Path.Combine(photoRootPath, "reports1nf_arenda_dogcontinue_photos");
		}

		IEnumerable<FileInfo> GetAllFiles()
		{
			string query = @"select file_name, file_ext from reports1nf_arenda_dogcontinue_photos a where a.free_square_id = @free_square_id";
	...
	public class BalansFreeSquarePhotosJpegBulder
	{
		Int32 Free_square_id;
		SqlConnection connectionSql;
		String photoRootPath, photo1NFPath;
