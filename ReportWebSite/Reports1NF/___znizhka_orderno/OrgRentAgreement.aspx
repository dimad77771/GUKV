                                            ...
                                            <PanelCollection>
                                                <dx:PanelContent ID="PanelContent11" runat="server">
                                                    <table border="0" cellspacing="0" cellpadding="2" width="1070px" style="display:block; height:120px; overflow:auto">
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka1_name" runat="server" Value='<%# Eval("znizhka1_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka1_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka1_percent") %>' Width="70px" Title="%">
                                                            ...
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka1_invnums" runat="server" Value='<%# Eval("znizhka1_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka1_orderno" runat="server" Value='<%# Eval("znizhka1_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka2_name" runat="server" Value='<%# Eval("znizhka2_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka2_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka2_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka2_invnums" runat="server" Value='<%# Eval("znizhka2_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka2_orderno" runat="server" Value='<%# Eval("znizhka2_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka3_name" runat="server" Value='<%# Eval("znizhka3_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka3_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka3_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka3_invnums" runat="server" Value='<%# Eval("znizhka3_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka3_orderno" runat="server" Value='<%# Eval("znizhka3_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka4_name" runat="server" Value='<%# Eval("znizhka4_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka4_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka4_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka4_invnums" runat="server" Value='<%# Eval("znizhka4_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka4_orderno" runat="server" Value='<%# Eval("znizhka4_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka5_name" runat="server" Value='<%# Eval("znizhka5_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka5_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka5_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka5_invnums" runat="server" Value='<%# Eval("znizhka5_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka5_orderno" runat="server" Value='<%# Eval("znizhka5_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka6_name" runat="server" Value='<%# Eval("znizhka6_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka6_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka6_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka6_invnums" runat="server" Value='<%# Eval("znizhka6_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka6_orderno" runat="server" Value='<%# Eval("znizhka6_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka7_name" runat="server" Value='<%# Eval("znizhka7_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka7_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka7_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka7_invnums" runat="server" Value='<%# Eval("znizhka7_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka7_orderno" runat="server" Value='<%# Eval("znizhka7_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka8_name" runat="server" Value='<%# Eval("znizhka8_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka8_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka8_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka8_invnums" runat="server" Value='<%# Eval("znizhka8_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka8_orderno" runat="server" Value='<%# Eval("znizhka8_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka9_name" runat="server" Value='<%# Eval("znizhka9_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka9_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka9_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka9_invnums" runat="server" Value='<%# Eval("znizhka9_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka9_orderno" runat="server" Value='<%# Eval("znizhka9_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td><dx:ASPxTextBox ID="edit_znizhka10_name" runat="server" Value='<%# Eval("znizhka10_name") %>' Width="430px" Title="Назва знижки"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left">
                                                                <dx:ASPxSpinEdit ID="edit_znizhka10_percent" runat="server" NumberType="Float" Value='<%# Eval("znizhka10_percent") %>' Width="70px" Title="%">
                                                                    <ClientSideEvents NumberChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                            ...
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="Інв.№"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxTextBox ID="znizhka10_invnums" runat="server" Value='<%# Eval("znizhka10_invnums") %>' Width="120px" Title="Інв.№">
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                            <td align="right"><dx:ASPxLabel runat="server" Text="№ знижки"></dx:ASPxLabel></td>
                                                            <td>
                                                                <dx:ASPxSpinEdit ID="znizhka10_orderno" runat="server" Value='<%# Eval("znizhka10_orderno") %>' Width="50px" Title="№ знижки" NumberType="Integer" >
                                                                    <ClientSideEvents ValueChanged="function (s, e) { NarazhCalculationRun(); }" />
                                                                </dx:ASPxSpinEdit>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr style="display:none">
												            ...
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left"><dx:ASPxSpinEdit ID="edit_zvilneno_percent" runat="server" NumberType="Float" Value='<%# Eval("zvilneno_percent") %>' Width="70px" Title="%"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                        ...
                                                        <tr style="display:none">
												            ...
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left"><dx:ASPxSpinEdit ID="edit_zvilbykmp6_percent" runat="server" NumberType="Float" Value='<%# Eval("zvilbykmp6_percent") %>' Width="70px" Title="%"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                        ...
                                                        <tr style="display:none">
												            ...
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left"><dx:ASPxSpinEdit ID="edit_zvilbykmp7_percent" runat="server" NumberType="Float" Value='<%# Eval("zvilbykmp7_percent") %>' Width="70px" Title="%"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
                                                        ...
                                                        <tr style="display:none">
												            ...
												            <td align="right"><dx:ASPxLabel runat="server" Text="%"></dx:ASPxLabel></td>
                                                            <td align="left"><dx:ASPxSpinEdit ID="edit_zvilbykmp3_percent" runat="server" NumberType="Float" Value='<%# Eval("zvilbykmp3_percent") %>' Width="70px" Title="%"/></td>
												            <td align="right"><dx:ASPxLabel runat="server" Text="з"></dx:ASPxLabel></td>
