...
public partial class Reports1NF_Cabinet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		if (!isjpeg)
		{
			var fname = @"free_" + "_" + id + ".pdf";
			var bytes = new PdfBulder().Go(id);
	...
	public class PdfBulder
	{
		...
		{
			string query = @"select file_name, file_ext from reports1nf_arenda_dogcontinue_current_stage_documents a where a.free_square_id = @free_square_id";
