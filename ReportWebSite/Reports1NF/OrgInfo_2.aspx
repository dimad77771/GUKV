<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgInfo.aspx.cs" Inherits="Reports1NF_OrgInfo"
    MasterPageFile="~/NoMenu.master" Title="Інформація про Організацію" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceIndustry" runat="server" 
    ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
    SelectCommand="SELECT id, name FROM dict_org_industry ORDER BY name">
</mini:ProfiledSqlDataSource>

<mini:ProfiledSqlDataSource ID="SqlDataSourceOccupation" runat="server" 
    ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
    SelectCommand="SELECT id, name FROM dict_org_occupation ORDER BY name">
</mini:ProfiledSqlDataSource>

<mini:ProfiledSqlDataSource ID="SqlDataSourceFormGosp" runat="server" 
    ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
    SelectCommand="SELECT id, name FROM dict_org_form_gosp ORDER BY name">
</mini:ProfiledSqlDataSource>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceOrgForm" runat="server" 
    ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
    SelectCommand="SELECT id, name FROM dict_org_form ORDER BY name">
</mini:ProfiledSqlDataSource>

<mini:ProfiledSqlDataSource ID="SqlDataSourceVedomstvo" runat="server" 
    ConnectionString="<%$ ConnectionStrings:GUKVConnectionString %>" 
    SelectCommand="SELECT id, name FROM dict_org_vedomstvo ORDER BY name">
</mini:ProfiledSqlDataSource>
            ...
            <PanelCollection>
                <dx:PanelContent ID="PanelContent7" runat="server">
                    <table border="0" cellspacing="0" cellpadding="2" width="810px">
                        ...
                        <tr>
                            <td><dx:ASPxLabel ID="ASPxLabel33" runat="server" Text="Сальдо платежів до бюджету, грн."></dx:ASPxLabel></td>
