...
--         SELECT R.report_id, SUM(NUM_GIVEN)  as 'NUM_GIVEN', SUM(R.SQR_GIVEN) AS 'SQR_GIVEN'
         ...
         SELECT 
			...
			GROUP BY ar.report_id,ar.agreement_num /*,ar.agreement_date,ar.rent_start_date,ar.rent_finish_date*/,ar.org_renter_id) R GROUP BY R.report_id /*, R.row_count*/) ObjectAndRentTotals3 ON ObjectAndRentTotals3.report_id = rep.report_id
--			GROUP BY ar.report_id ,ar.agreement_num /*,ar.agreement_date,ar.rent_start_date,ar.rent_finish_date,ar.org_giver_id*/) R GROUP BY R.report_id /*, R.row_count*/) ObjectAndRentTotals3 ON ObjectAndRentTotals3.report_id = rep.report_id
		...
		SELECT
            ...
            WHERE NOT EXISTS(SELECT id FROM arenda a WHERE a.id = pay.arenda_id AND ISNULL(a.is_deleted, 1) = 1) 
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="old_industry" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="14" Visible="False" Caption="Галузь (Баланс)"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="old_occupation" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="15" Visible="False" Caption="Вид Діяльності (Баланс)" Width="120px"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="form_gosp" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="16" Visible="False" Caption="Форма фінансування"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="old_organ" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="21" Visible="False" Caption="Орган госп. упр."></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="status" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="22" Visible="False" Caption="Фіз. / Юр. Особа"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="director_phone" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="24" Visible="False" Caption="Відповідальна особа"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="fax" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="27" Visible="False" Caption="Факс"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn Caption="Отримано орендної плати всього за звітний період, грн. (без ПДВ)" FieldName="PAY_RECV_ZVIT" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="58"  />
        <dx:GridViewDataTextColumn Caption="Отримано орендної плати в тому числі з нарахованої за звітний період, грн. (без ПДВ)" FieldName="PAY_RECV_NARAH" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="59"  />
        ...
        <dx:GridViewDataTextColumn Caption="Погашення заборгованості минулих періодів" FieldName="PAY_LAST_PER" ReadOnly="true" ShowInCustomizationForm="true" VisibleIndex="61"  />
