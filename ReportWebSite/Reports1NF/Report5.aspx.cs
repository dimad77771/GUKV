...
--org_balans_zkpo,
--org_renter_zkpo,
org_giver_full_name as ""Орендодавець - Повна Назва"",
...
m.agreement_date as ""Дата договору"",
...
where ar.id = " + ID;
			...
			properties.Add("{Дата укладання договору}", GetDate(r["Дата договору"]));
			...
			properties.Add("{Орендодавець - Повна Назва}", r["Орендодавець - Повна Назва"]);
		}
