...
<mini:ProfiledSqlDataSource ID="SqlDataSourceReportBalans" runat="server" 
    ...
    SelectCommand="SELECT 
        ...
        outer apply (select sum(fs.total_free_sqr) as total_free_sqr from reports1nf_balans_free_square fs where fs.balans_id = bal.id and fs.report_id = bal.report_id) bfs 
...
<dx:ASPxGridView ID="PrimaryGridView" ClientInstanceName="PrimaryGridView" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="num_rent_agr" VisibleIndex="12" Caption="Кількість договорів оренди"></dx:GridViewDataTextColumn>
