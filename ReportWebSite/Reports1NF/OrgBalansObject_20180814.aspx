                                ...
                                <PanelCollection>
                                    <dx:PanelContent ID="PanelContent2" runat="server">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2" width="990px">
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel ID="ASPxLabel39" runat="server" Text="Площа нежилих приміщень будинку, кв.м" Width="125px"></dx:ASPxLabel></td>
                                                <td>
                                                ...
                                                <td><dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Площа житлового фонду будинку, кв.м"></dx:ASPxLabel></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><dx:ASPxLabel ID="ASPxLabel45" runat="server" Text="Площа підвалу будинку, кв.м"></dx:ASPxLabel></td>
                                                <td>
                                                ...
                                                <td><dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Площа горища будинку, кв.м"></dx:ASPxLabel></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <dx:ASPxCheckBox ID="CheckBasementExists" ClientInstanceName="CheckBasementExists" runat="server" Text="Підвал існує" Value='<%# 1.Equals(Eval("is_basement_exists")) %>' Title="Підвал існує" Visible ="false">
                                                        <ClientSideEvents CheckedChanged="function (s,e) { EditBuildingSqrBasement.SetEnabled(CheckBasementExists.GetChecked()); }" />
                                                    </dx:ASPxCheckBox>
                                                </td>
                                                <td colspan="2">
                                                    <dx:ASPxCheckBox ID="CheckLoftExists" ClientInstanceName="CheckLoftExists" runat="server" Text="Горище існує" Value='<%# 1.Equals(Eval("is_loft_exists")) %>' Title="Горище існує" Visible ="false">
