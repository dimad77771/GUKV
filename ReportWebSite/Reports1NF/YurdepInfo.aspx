<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YurdepInfo.aspx.cs" Inherits="Reports1NF_Yursprava"
    MasterPageFile="~/NoHeader.master" Title="Судовий реєстр" %>
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle1" runat="server" Text="Судовий реєстр" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridViewExporter ID="GridViewFreeSquareExporter" runat="server" 
   ...
   <dx:ASPxGridView ID="PrivatisatGridView" runat="server" AutoGenerateColumns="False" 
        ...
        OnInitNewRow="PrivatisatGridView_InitNewRow"
