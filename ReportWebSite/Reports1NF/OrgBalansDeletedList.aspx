<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgBalansDeletedList.aspx.cs" Inherits="Reports1NF_OrgBalansDeletedList"
    MasterPageFile="~/NoHeader.master" Title="Відчужені Об'єкти" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceBalansStatus" runat="server" 
    ...
    SelectCommand="SELECT CASE WHEN COUNT(*) > 0 THEN 0 ELSE 1 END AS 'report_balans_status'
        ...
        WHERE bal.report_id = @rep_id AND (((bal.is_valid = 0) OR (bal.is_valid IS NULL)) OR (bal.submit_date IS NULL OR bal.modify_date > bal.submit_date))">
    <SelectParameters>
