                                    ...
                                    <dx:PanelContent ID="PanelContent3" runat="server">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2" width="990px">
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxSpinEdit ID="EditObjFreeSquare" ClientInstanceName="EditObjFreeSquare" runat="server" NumberType="Float" Value='<%# Eval("free_sqr_useful") %>' Width="250px" Title="Корисна площа вільного приміщення" ReadOnly="true">
                                                        <ValidationSettings Display="None"></ValidationSettings>
                                                        <ClientSideEvents
