<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report1NFFreeMap_new2.aspx.cs" Inherits="Reports1NF_Report1NFFreeMap"
	...
	require([
		...
		ArcGISDynamicMapServiceLayer, Map, SimpleFillSymbol, SimpleLineSymbol
			...
			map = new Map("ui-esri-map", {
				basemap: "topo",
				center: [30.539254, 50.43902], // long, lat
				zoom: 14,
				sliderStyle: "small",
				//infoWindow: popup
			});
			...
			//console.log("geocoder.startup", geocoder.startup);
			//geocoder.startup();
		});
