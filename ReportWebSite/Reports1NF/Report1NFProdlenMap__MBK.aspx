<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report1NFProdlenMap__MBK.aspx.cs" Inherits="Reports1NF_Report1NFProdlenMap"
    MasterPageFile="~/ProdlenShowPublic2.master" Title="Мапа оголошених аукціонів для оренди" %>
    ...
    <script>
		...
		require([
			...
			function mapLoaded() {
				...
				var myIcon_1 = '../Styles/Map__marker_4b.png';
				...
				for (n = 0; n < allPoints.length; n++) {
					...
					var icon = (apoint.source == '2' ? myIcon_3 : myIcon_1);
