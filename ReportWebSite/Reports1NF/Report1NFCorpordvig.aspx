<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report1NFCorpordvig.aspx.cs" Inherits="Reports1NF_Report1NFCorpordvig"
    MasterPageFile="~/NoHeader.master" Title="Реєстр руху корпоративних прав" %>
...
DeleteCommand="DELETE FROM [corpordvig] WHERE id = @id" 

UpdateCommand="UPDATE [corpordvig]
SET
	[uridzkpo] = @uridzkpo
	,[uridname] = @uridname
	,[dateoper] = @dateoper
...
WHERE id = @id" 
    ...
    InsertCommand="INSERT INTO [corpordvig]
    ([uridzkpo]
	,[uridname]
	,[dateoper]
	,[uchotrim]
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle1" runat="server" Text="Реєстр руху корпоративних прав" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridViewExporter ID="GridViewFreeSquareExporter" runat="server" 
   ...
   <dx:ASPxGridView ID="PrivatisatGridView" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="uridzkpo" Caption="ЕДРПОУ об'єкту комунальної власності" Width="90px" CellStyle-HorizontalAlign="Center">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="uridname" Caption="Назва об'єкту комунальної власності" Width="160px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataDateColumn FieldName="dateoper" Caption="Дата операції" Width="80px" CellStyle-HorizontalAlign="Center">
        </dx:GridViewDataDateColumn>
        <dx:GridViewDataTextColumn FieldName="uchotrim" Caption="Учасник отримувач" Width="120px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="uchpered" Caption="Учасник передавач" Width="120px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
		<dx:GridViewDataTextColumn FieldName="typeoper" Caption="Тип правової операції" Width="80px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataSpinEditColumn FieldName="akckol" Caption="Кількість акцій, шт." Width="100px">
            <PropertiesSpinEdit NumberType="Float" NumberFormat="Number">
                <SpinButtons Enabled="false" ClientVisible="false" ></SpinButtons>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="akcvart" Caption="Вартість акцій, грн." Width="100px">
            <PropertiesSpinEdit NumberType="Float" NumberFormat="Number">
                <SpinButtons Enabled="false" ClientVisible="false" ></SpinButtons>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
		<dx:GridViewDataTextColumn FieldName="akctype" Caption="Тип акцій" Width="80px" CellStyle-HorizontalAlign="Center">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataSpinEditColumn FieldName="partfact" Caption="Розмір частки у СК фактичний" Width="100px">
            <PropertiesSpinEdit NumberType="Float" NumberFormat="Number">
                <SpinButtons Enabled="false" ClientVisible="false" ></SpinButtons>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="partplan" Caption="Розмір частки у СК за планом" Width="100px">
            <PropertiesSpinEdit NumberType="Float" NumberFormat="Number">
                <SpinButtons Enabled="false" ClientVisible="false" ></SpinButtons>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
		<dx:GridViewDataTextColumn FieldName="methodoper" Caption="Метод проведення операції" Width="80px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
		<dx:GridViewDataTextColumn FieldName="docoper" Caption="Документ щодо операції" Width="100px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
		<dx:GridViewDataTextColumn FieldName="platnik" Caption="Платник коштів по операції" Width="100px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
		<dx:GridViewDataTextColumn FieldName="oderzh" Caption="Одержувач коштів по операції" Width="100px" CellStyle-HorizontalAlign="Left">
        </dx:GridViewDataTextColumn>
    ...
    <SettingsCookies CookiesID="GUKV.Reports1NF.CorpordvigSquare" Version="A1_17" Enabled="false" />
