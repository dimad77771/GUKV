...
<dx:ASPxGridView ID="PrimaryGridView" ClientInstanceName="PrimaryGridView" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="purpose" VisibleIndex="43" Caption="Цільове використання майна" ShowInCustomizationForm="True" Visible="False"><Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" /></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="zabezdepoz_saldo" VisibleIndex="51" Caption="Сальдо авансової орендної плати на кінець звітного періоду, грн. (без ПДВ)" ShowInCustomizationForm="True" Visible="False"><Settings AllowHeaderFilter="True" /></dx:GridViewDataTextColumn>
