...
/// </summary>
public class UserFoldersDataSourceView : HierarchicalDataSourceView
{
    private UserReportDataSourceFolderItem folder = null;

    public UserFoldersDataSourceView(UserReportDataSourceFolderItem f)
    {
        folder = f;
    }
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                items.Add(new UserReportDataSourceFolderItem(
                                    ...
                                    false, /* Enumerate reports */
                                    false /* Use global URLs for report sub-nodes */ ));
                            }
