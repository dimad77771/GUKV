...
public static class OpenXMLExcel {
    ...
    public static bool AddBasicStyles(DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet)
    {
        ...
        stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Fonts>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.Font>(
            new DocumentFormat.OpenXml.Spreadsheet.Font()
            {
                ...
                FontName = new DocumentFormat.OpenXml.Spreadsheet.FontName() { Val = "Calibri" }
            },
            0);
        ...
        stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Fonts>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.Font>(
            new DocumentFormat.OpenXml.Spreadsheet.Font()
            {
                FontSize = new DocumentFormat.OpenXml.Spreadsheet.FontSize() { Val = 11 },
                FontName = new DocumentFormat.OpenXml.Spreadsheet.FontName() { Val = "Calibri" },
                Bold = new DocumentFormat.OpenXml.Spreadsheet.Bold() { Val = DocumentFormat.OpenXml.BooleanValue.FromBoolean(true) }
            },
            1);
        ...
        stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.Fills>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.Fill>(
            new DocumentFormat.OpenXml.Spreadsheet.Fill()
            {
                PatternFill = new DocumentFormat.OpenXml.Spreadsheet.PatternFill()
                {
                    ...
                    {
                        Rgb = DocumentFormat.OpenXml.HexBinaryValue.FromString("FFFFFF00")
                    },

                    BackgroundColor = new BackgroundColor()
                    {
                        Indexed = new DocumentFormat.OpenXml.UInt32Value((uint)64)
                    }
                }
            },
            2);
        ...
        // Simple text with yellow background
        stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.CellFormats>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.CellFormat>(
            new DocumentFormat.OpenXml.Spreadsheet.CellFormat()
            {
                FormatId = 0,
                ...
                FontId = 0,
                FillId = 2,
                ApplyFill = DocumentFormat.OpenXml.BooleanValue.FromBoolean(true)
            },
            6);

        // Decimal with yellow background
        stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.CellFormats>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.CellFormat>(
            new DocumentFormat.OpenXml.Spreadsheet.CellFormat()
            {
                ApplyNumberFormat = true,
        ...
        // Simple text with wrapping
        DocumentFormat.OpenXml.Spreadsheet.CellFormat cellFormat = new CellFormat()
        {
            FormatId = 0,
            NumberFormatId = 0
        };

        cellFormat.AppendChild<DocumentFormat.OpenXml.Spreadsheet.Alignment>(
            new DocumentFormat.OpenXml.Spreadsheet.Alignment()
            {
                WrapText = DocumentFormat.OpenXml.BooleanValue.FromBoolean(true)
            }
        );
    ...
    public static bool AddSharedStrings(DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet, System.Collections.Generic.List<string> stringList)
    {
        ...
        {
            OpenXMLExcel.AddSharedString(spreadsheet, item, false);
        }
        ...
        uint columnIndex, uint rowIndex, string stringValue, bool useSharedString, bool save = true)
    {
        ...
        if (useSharedString)
        {
            if (OpenXMLExcel.IndexOfSharedString(spreadsheet, stringValue) == -1)
            {
                OpenXMLExcel.AddSharedString(spreadsheet, stringValue, true);
            }

            columnValue = OpenXMLExcel.IndexOfSharedString(spreadsheet, stringValue).ToString();
    ...
    public static bool SetCellValue(
        DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet,
        DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet,
        uint columnIndex, uint rowIndex, System.DateTime datetimeValue, uint? styleIndex, bool save = true)
    {
    ...
    public static bool SetCellValue(
        DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet,
        DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet,
        uint columnIndex, uint rowIndex, double doubleValue, uint? styleIndex, bool save = true)
    {
    ...
    public static bool SetCellValue(
        DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet,
        DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet,
        uint columnIndex, uint rowIndex, bool boolValue, uint? styleIndex, bool save = true)
    {
    ...
    /// <summary>
    /// Sets a cell value with formatted string
    /// </summary>
    /// <param name="spreadsheet">Spreadsheet to use</param>
    /// <param name="worksheet">Worksheet to use</param>
    /// <param name="columnIndex">Index of the column</param>
    ...
    public static bool SetCellValue(
        ...
        string value, uint? styleIndex, bool save = true)
    {
        return SetCellValue(
            spreadsheet,
            worksheet,
    ...
    private static bool SetCellValue(
        ...
        DocumentFormat.OpenXml.Spreadsheet.Worksheet worksheet,
        uint columnIndex, uint rowIndex,
        DocumentFormat.OpenXml.Spreadsheet.CellValues valueType,
        string value, uint? styleIndex, bool save = true)
    {
        ...
        string cellAddress = OpenXMLExcel.ColumnNameFromIndex(columnIndex) + rowIndex;
        ...
        else
        {
            ...
            {
                previousCell = row.Elements<DocumentFormat.OpenXml.Spreadsheet.Cell>().Where(item => item.CellReference.Value == OpenXMLExcel.ColumnNameFromIndex(counter) + rowIndex).FirstOrDefault();
