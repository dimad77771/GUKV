...
public partial class Balans_BalansOther : System.Web.UI.Page
{
    ...
    protected void SqlDataSourceKievenergo_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
    ...
    protected void GridViewBalansKievenergo_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
    ...
    protected void ASPxButton_BalansKievenergo_ExportXLS_Click(object sender, EventArgs e)
    {
        this.ExportGridToXLS(ASPxGridViewExporterBalansKievenergo, PrimaryGridView, LabelReportTitle3.Text);
    }

    protected void ASPxButton_BalansKievenergo_ExportPDF_Click(object sender, EventArgs e)
    {
        this.ExportGridToPDF(ASPxGridViewExporterBalansKievenergo, PrimaryGridView, LabelReportTitle3.Text);
    }

    protected void ASPxButton_BalansKievenergo_ExportCSV_Click(object sender, EventArgs e)
    {
        this.ExportGridToCSV(ASPxGridViewExporterBalansKievenergo, PrimaryGridView, LabelReportTitle3.Text);
    }
}
