<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dict_expert_detail_purpose.aspx.cs" Inherits="Catalogue_OrgCatalogue" MasterPageFile="~/NoHeader.master" 
	Title="Довідник 'НЕВ'" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceAllOrganizations" runat="server" EnableCaching="false"
    ...
    SelectCommand="select name, id from [dict_expert_detail_purpose] order by 1"
	UpdateCommand="UPDATE [dict_expert_detail_purpose] SET [name] = @name WHERE id = @id"
	InsertCommand="INSERT INTO [dict_expert_detail_purpose]([id],[name]) VALUES( isnull((select max(id) + 1 from dict_expert_detail_purpose), 1), @name)"
	DeleteCommand="DELETE FROM [dict_expert_detail_purpose] WHERE id = @id">
    <UpdateParameters>
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle2" runat="server" Text="Довідник 'НЕВ'" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="name" Caption="НЕВ" Width="900px"></dx:GridViewDataTextColumn>
    </Columns>
    ...
    <SettingsCookies CookiesID="GUKV.Catalogue.dict_expert_detail_purpose" Version="A2" Enabled="false" />
