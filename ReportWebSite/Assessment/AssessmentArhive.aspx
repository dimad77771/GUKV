<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssessmentArhive.aspx.cs" Inherits="Assessment_AssessmentObjects" MasterPageFile="~/NoHeader.master" Title="Оцінка Об'єктів"%>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceAssessmentObjects" runat="server" EnableCaching="false"
    ...
    SelectCommand="SELECT * FROM AssessmentArhive">
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle1" runat="server" Text="Архів об'єктів оцінки" CssClass="reporttitle"></asp:Label>
			<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="v2" Caption="C/O" Width="50"/>
        <dx:GridViewDataTextColumn FieldName="v3" Caption="Вхідний №" Width="150"/>
        <dx:GridViewDataTextColumn FieldName="v4" Caption="Кореспондент" Width="100"/>
        <dx:GridViewDataTextColumn FieldName="v5" Caption="Контрольна дата" Width="80"/>
        <dx:GridViewDataTextColumn FieldName="v6" Caption="Рецензент" Width="150"/>
        <dx:GridViewDataTextColumn FieldName="v7" Caption="СОД" Width="180"/>
        <dx:GridViewDataTextColumn FieldName="v8" Caption="Вулиця" Width="140"/>
        <dx:GridViewDataTextColumn FieldName="v9" Caption="Номер" Width="50"/>
        <dx:GridViewDataTextColumn FieldName="v10" Caption="Тип об'єкта оцінки" Width="160"/>
        <dx:GridViewDataTextColumn FieldName="v11" Caption="Площа кв. м." Width="80"/>
        <dx:GridViewDataTextColumn FieldName="v12" Caption="Вихідний №" Width="160"/>
        <dx:GridViewDataTextColumn FieldName="v13" Caption="Категорія рецензування" Width="145"/>
        <dx:GridViewDataTextColumn FieldName="v14" Caption="Балансоутримувач" Width="200"/>
        <dx:GridViewDataTextColumn FieldName="v15" Caption="Дата оцінки" Width="100"/>
        <dx:GridViewDataTextColumn FieldName="v16" Caption="Орендар" Width="300"/>
        <dx:GridViewDataTextColumn FieldName="v17" Caption="Розбивка площі" Width="100"/>
        <dx:GridViewDataTextColumn FieldName="v18" Caption="Поверх" Width="100"/>
        <dx:GridViewDataTextColumn FieldName="v19" Caption="НЕВ" Width="100"/>
        <dx:GridViewDataTextColumn FieldName="v20" Caption="Вартість 1 кв.м/$" Width="120"/>
        <dx:GridViewDataTextColumn FieldName="v21" Caption="Вартість об'єкта, грн (без ПДВ)" Width="120"/>
        <dx:GridViewDataTextColumn FieldName="v22" Caption="Дата затвердження" Width="80"/>
        <dx:GridViewDataTextColumn FieldName="v23" Caption="Архівний №" Width="80"/>
        <dx:GridViewDataTextColumn FieldName="v24" Caption="Примітка" Width="150"/>
    ...
    <SettingsCookies CookiesID="GUKV.Assessment.Arhive" Version="A101" Enabled="false" />
