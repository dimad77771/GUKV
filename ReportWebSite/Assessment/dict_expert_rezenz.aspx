<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dict_expert_rezenz.aspx.cs" Inherits="Catalogue_OrgCatalogue" MasterPageFile="~/NoHeader.master" 
	Title="Довідник 'Рецензент'" %>
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle2" runat="server" Text="Довідник 'Рецензент'" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataCheckColumn FieldName="is_dkv" Caption="ДКВ" Width="80px"></dx:GridViewDataCheckColumn>
    ...
    <SettingsCookies CookiesID="GUKV.Catalogue.dict_expert_rezenz" Version="A3" Enabled="false" />
