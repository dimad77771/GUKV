<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dict_expert_stan.aspx.cs" Inherits="Catalogue_OrgCatalogue" MasterPageFile="~/NoHeader.master" 
	Title="Довідник 'Стан рецензії'" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceAllOrganizations" runat="server" EnableCaching="false"
    ...
    SelectCommand="select name, id from [dict_expert_stan] order by 1"
	UpdateCommand="UPDATE [dict_expert_stan] SET [name] = @name WHERE id = @id"
	InsertCommand="INSERT INTO [dict_expert_stan]([id],[name]) VALUES( isnull((select max(id) + 1 from dict_expert_stan), 1), @name)"
	DeleteCommand="DELETE FROM [dict_expert_stan] WHERE id = @id">
    <UpdateParameters>
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle2" runat="server" Text="Довідник 'Стан рецензії'" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="name" Caption="Стан рецензії" Width="900px"></dx:GridViewDataTextColumn>
    </Columns>
    ...
    <SettingsCookies CookiesID="GUKV.Catalogue.dict_expert_stan" Version="A2" Enabled="false" />
