...
<mini:ProfiledSqlDataSource ID="SqlDataSourceAllOrganizations" runat="server" EnableCaching="false"
    ...
    SelectCommand="select name, id, color_rgb from [dict_expert_rezenz_type] order by 1"
	UpdateCommand="UPDATE [dict_expert_rezenz_type] SET [name] = @name, [color_rgb] = @color_rgb WHERE id = @id"
	InsertCommand="INSERT INTO [dict_expert_rezenz_type]([id],[name],[color_rgb]) VALUES( isnull((select max(id) + 1 from dict_expert_rezenz_type), 1), @name, isnull(@color_rgb,0))"
	DeleteCommand="DELETE FROM [dict_expert_rezenz_type] WHERE id = @id">
    <UpdateParameters>
        <asp:Parameter Name="name" />
		<asp:Parameter Name="id" />
		<asp:Parameter Name="color_rgb" Type="Int32" />
	</UpdateParameters>
	<InsertParameters>
        <asp:Parameter Name="name" />
		<asp:Parameter Name="color_rgb" Type="Int32" />
...
<dx:ASPxGridView
	...
	OnRowUpdating="PrimaryGridView_RowUpdating"
	OnRowInserted="PrimaryGridView_RowInserted"
	OnInitNewRow="PrimaryGridView_InitNewRow"
	>
    ...
    <SettingsCookies CookiesID="GUKV.Catalogue.dict_expert_rezenz_type" Version="A2" Enabled="false" />
