<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dict_expert_valuation_kind.aspx.cs" Inherits="Catalogue_OrgCatalogue" MasterPageFile="~/NoHeader.master" 
	Title="Довідник 'Вид рецензії'" %>
...
<mini:ProfiledSqlDataSource ID="SqlDataSourceAllOrganizations" runat="server" EnableCaching="false"
    ...
    SelectCommand="select name, id from [dict_expert_valuation_kind] order by 1"
	UpdateCommand="UPDATE [dict_expert_valuation_kind] SET [name] = @name, [short_name] = @name WHERE id = @id"
	InsertCommand="INSERT INTO [dict_expert_valuation_kind]([id],[name],[short_name]) VALUES( isnull((select max(id) + 1 from dict_expert_valuation_kind), 1), @name,@name)"
	DeleteCommand="DELETE FROM [dict_expert_valuation_kind] WHERE id = @id">
    <UpdateParameters>
...
<table border="0" cellspacing="4" cellpadding="0" width="100%">
    <tr>
        <td style="width: 100%;">
            <asp:Label ID="LabelReportTitle2" runat="server" Text="Довідник 'Вид рецензії'" CssClass="reporttitle"></asp:Label>
        </td>
        <td>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="name" Caption="Вид рецензії" Width="900px"></dx:GridViewDataTextColumn>
    </Columns>
    ...
    <SettingsCookies CookiesID="GUKV.Catalogue.dict_expert_valuation_kind" Version="A2" Enabled="false" />
