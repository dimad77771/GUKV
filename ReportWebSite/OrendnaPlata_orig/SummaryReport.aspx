<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SummaryReport.aspx.cs" Inherits="OrendnaPlata_SummaryReport"
...
<dx:ASPxMenu ID="SectionMenu" runat="server" Width="100%" ItemAutoWidth="False" ItemStyle-HorizontalAlign="Left">
    <Items>
        ...
        <dx:MenuItem NavigateUrl="../OrendnaPlata/SummaryReport.aspx" Text="Зведений Звіт"></dx:MenuItem>
...
<dx:ASPxGridView
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="bal_org_occupation_name" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1" Visible="True" Caption="Сфера Діяльності"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="budget_zvit_50_uah" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="8" Visible="False" Caption="Відрахування 50% До Бюджету (грн.)"></dx:GridViewDataTextColumn>
