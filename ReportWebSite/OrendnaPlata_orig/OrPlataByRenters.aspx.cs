...
public partial class OrendnaPlata_OrPlataByRenters : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (isFirstLoading)
        {
            ...
            if (this.ProcessPageLoad(out reportTitle, out preFilter, out fixedColumns) == Utils.GridIDOrendnaPlata_ByRenters)
            {
    ...
    protected void ASPxButton_RentByRenters_ExportXLS_Click(object sender, EventArgs e)
    {
        this.ExportGridToXLS(GridViewRentByRentersExporter, PrimaryGridView, LabelReportTitle2.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByRenters_ExportPDF_Click(object sender, EventArgs e)
    {
        this.ExportGridToPDF(GridViewRentByRentersExporter, PrimaryGridView, LabelReportTitle2.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByRenters_ExportCSV_Click(object sender, EventArgs e)
    {
        this.ExportGridToCSV(GridViewRentByRentersExporter, PrimaryGridView, LabelReportTitle2.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void GridViewRentByRenters_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        string param = e.Parameters;

        Utils.ProcessGridPageSizeInCallback(PrimaryGridView, ref param, 35);

        Utils.ProcessDataGridSaveLayoutCallback(param, PrimaryGridView, Utils.GridIDOrendnaPlata_ByRenters, "");
    }

    protected void GridViewRentByRenters_CustomFilterExpressionDisplayText(object sender,
    ...
    protected void GridViewRentByRenters_ProcessColumnAutoFilter(object sender,
        DevExpress.Web.ASPxGridViewAutoFilterEventArgs e)
    {
        Utils.ProcessGridColumnAutoFilter(sender, e);
    }

    protected void SqlDataSourceRentByRenters_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
