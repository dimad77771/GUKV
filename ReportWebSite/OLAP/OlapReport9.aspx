...
<table>
	...
	<tr>
		<td>
<dx:WebChartControl ID="WebChartControl_2025" runat="server" Height="500px"
        Width="1500px" ClientInstanceName="chart"
        CrosshairEnabled="False" ToolTipEnabled="true" RenderFormat="Svg">

        <Titles>
            <dx:ChartTitle Text="Заборгованість по орендній платі (10 найбільших боржників) за 2025 рік" Font="Tahoma, 14pt"></dx:ChartTitle>
        </Titles>
	...
	<tr>
		<td>
<dx:WebChartControl ID="WebChartControl_2024" runat="server" Height="500px"
        Width="1500px" ClientInstanceName="chart"
        CrosshairEnabled="False" ToolTipEnabled="true" RenderFormat="Svg">

        <Titles>
            <dx:ChartTitle Text="Заборгованість по орендній платі (10 найбільших боржників) за 2024 рік" Font="Tahoma, 14pt"></dx:ChartTitle>
        </Titles>
	...
	<tr>
		<td>
<dx:WebChartControl ID="WebChartControl_2023" runat="server" Height="500px"
        Width="1500px" ClientInstanceName="chart"
        CrosshairEnabled="False" ToolTipEnabled="true" RenderFormat="Svg">

        <Titles>
            <dx:ChartTitle Text="Заборгованість по орендній платі (10 найбільших боржників) за 2023 рік" Font="Tahoma, 14pt"></dx:ChartTitle>
        </Titles>
