...
public partial class Assessment_AssessmentObjects : System.Web.UI.Page
{
	...
	void LoadData()
	{
		var seria1 = new Series("Нарахована сума до бюджету % від загальної суми надходжень орендної плати за звітний період грн. (без ПДВ)", ViewType.Area);
		var seria2 = new Series("Перераховано коштів до бюджету у звітному періоді \"КАЗНАЧЕЙСТВО\" грн. (без ПДВ)", ViewType.Area);
		...
		//seria1.View.Color = Color.Red;
		//seria2.View.Color = Color.Blue;
