...
public partial class OrendnaPlata_OrendnaPlataByBalans : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (isFirstLoading)
        {
            ...
            if (this.ProcessPageLoad(out reportTitle, out preFilter, out fixedColumns) == Utils.GridIDOrendnaPlata_ByBalansOrg)
            {
    ...
    protected void ASPxButton_RentByBalansOrg_ExportXLS_Click(object sender, EventArgs e)
    {
        this.ExportGridToXLS(GridViewRentByBalansOrgExporter, PrimaryGridView, LabelReportTitle1.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByBalansOrg_ExportPDF_Click(object sender, EventArgs e)
    {
        this.ExportGridToPDF(GridViewRentByBalansOrgExporter, PrimaryGridView, LabelReportTitle1.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByBalansOrg_ExportCSV_Click(object sender, EventArgs e)
    {
        this.ExportGridToCSV(GridViewRentByBalansOrgExporter, PrimaryGridView, LabelReportTitle1.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void GridViewRentByBalansOrg_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        string param = e.Parameters;

        Utils.ProcessGridPageSizeInCallback(PrimaryGridView, ref param, 35);

        Utils.ProcessDataGridSaveLayoutCallback(param, PrimaryGridView, Utils.GridIDOrendnaPlata_ByBalansOrg, "");
    }

    protected void GridViewRentByBalansOrg_CustomFilterExpressionDisplayText(object sender,
    ...
    protected void GridViewRentByBalansOrg_ProcessColumnAutoFilter(object sender,
        DevExpress.Web.ASPxGridViewAutoFilterEventArgs e)
    {
        Utils.ProcessGridColumnAutoFilter(sender, e);
    }

    protected void SqlDataSourceRentByBalansOrg_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
