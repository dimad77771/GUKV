...
public partial class OrendnaPlata_OrPlataByBuildings : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (isFirstLoading)
        {
            ...
            if (this.ProcessPageLoad(out reportTitle, out preFilter, out fixedColumns) == Utils.GridIDOrendnaPlata_ByBuildings)
            {
    ...
    protected void ASPxButton_RentByBuildings_ExportXLS_Click(object sender, EventArgs e)
    {
        this.ExportGridToXLS(GridViewRentByBuildingsExporter, PrimaryGridView, LabelReportTitle3.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByBuildings_ExportPDF_Click(object sender, EventArgs e)
    {
        this.ExportGridToPDF(GridViewRentByBuildingsExporter, PrimaryGridView, LabelReportTitle3.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void ASPxButton_RentByBuildings_ExportCSV_Click(object sender, EventArgs e)
    {
        this.ExportGridToCSV(GridViewRentByBuildingsExporter, PrimaryGridView, LabelReportTitle3.Text, ViewState["PrimaryGridView.DataSourceID"] as string);
    }

    protected void GridViewRentByBuildings_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        string param = e.Parameters;

        Utils.ProcessGridPageSizeInCallback(PrimaryGridView, ref param, 35);

        Utils.ProcessDataGridSaveLayoutCallback(param, PrimaryGridView, Utils.GridIDOrendnaPlata_ByBuildings, "");
    }
    ...
    protected void SqlDataSourceRentByBuildings_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
