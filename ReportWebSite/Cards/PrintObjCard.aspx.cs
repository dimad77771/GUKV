...
public partial class Cards_PrintObjCard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ReportObjectCard report = new ReportObjectCard(Request.QueryString["bid"], Request.QueryString["balid"]);
