<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgCard.aspx.cs" Inherits="Cards_OrgCard"
    MasterPageFile="~/NoHeader.master" Title="Картка Організації" ValidateRequest="false" %>
            ...
            <PanelCollection>
                <dx:PanelContent ID="PanelContent2" runat="server" SupportsDisabledAttribute="True">
                    <table border="0" cellspacing="0" cellpadding="0" width="810px">
                        ...
                        <tr><td colspan="7" height="4px"/></tr>
                        <tr>
                            <td width="100px"><dx:ASPxLabel ID="ASPxLabel38" runat="server" Text="Відповідальна особа"></dx:ASPxLabel></td>
                            <td width="8px">&nbsp;</td>
                            <td colspan="5"><dx:ASPxTextBox ID="EditDirectorTitle" runat="server" ReadOnly="True" Text='<%# Eval("director_title") %>' Width="700px" Title="ПІБ та телефон відповідальної особи" /></td>
                        </tr>
                    </table>
                </dx:PanelContent>
            </PanelCollection>
